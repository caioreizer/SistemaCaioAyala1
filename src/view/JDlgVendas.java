...
public class JDlgVendas extends javax.swing.JDialog {
    ...
    public CraVendas viewBean() throws ParseException {
        CraVendas vendas = new CraVendas();
        vendas.setCraIdVendas( Util.strToInt(jTxtCodigo.getText()));
        vendas.getCraDataVenda(Util.strToDate(jFmtData.getText()));
...
//            jPwfSenha, jCboNivel, jChbAtivo);
    ...
    private void jBtnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnConfirmarActionPerformed
        // TODO add your handling code here:
         // VendasDAO vendasDAO = new UsuariosDAO();;;;;
