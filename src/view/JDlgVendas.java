...
public class JDlgVendas extends javax.swing.JDialog {
    ...
    public JDlgVendas(java.awt.Frame parent, boolean modal) {
        ...
        setLocationRelativeTo(null);
         ...
         List<CraClientes> lista = clientesDAO.listAll(); // use tipo genérico!

         jCboClientes.removeAllItems(); // limpa antes de preencher
        for (CraClientes cliente : lista) {
        jCboClientes.addItem(cliente); // adiciona o OBJETO, não String
    }
    ...
    private void jBtnExcluirProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnExcluirProdActionPerformed
        ...
        Util.limpar(jTxtCodigo1, jTxtFormaPagamento, jTxtStatus, jTxtTotal, jFmtData,
                jCboClientes, jCboFuncionario);
    ...
    void beanView(CraVendas vendas) {
